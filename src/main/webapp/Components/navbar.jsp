<%@page import="com.qrshop.entities.Admin"%>
<%@page import="com.qrshop.entities.Cart"%>
<%@page import="com.qrshop.dao.CartDao"%>
<%@page import="com.qrshop.entities.User"%>
<%@page import="java.util.List"%>
<%@page import="com.qrshop.entities.Category"%>
<%@page import="com.qrshop.helper.ConnectionProvider"%>
<%@page import="com.qrshop.dao.CategoryDao"%>
<%
