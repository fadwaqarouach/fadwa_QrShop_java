<%@page import="com.qrshop.entities.Message"%>
<%@page import="com.qrshop.entities.OrderedProduct"%>
<%@page import="com.qrshop.entities.Order"%>
<%@page import="java.util.List"%>
<%@page import="com.qrshop.dao.OrderedProductDao"%>
<%@page import="com.qrshop.dao.OrderDao"%>
<%@page import="com.qrshop.helper.ConnectionProvider"%>
<%@page import="com.qrshop.entities.User"%>
